			...
			<div class="inner">
				...
				<?php
					foreach($all_photo_arr as $key => $photo)
					{
						...
						$thumb_image_url = wp_get_attachment_image_src( $photo->ID, 'thumbnail' );
				...
				<div class="one_third <?php echo $last_class; ?> gallery3" style="margin-top:3%">
    				...
    				?>		
							...
							<a rel="gallery" href="<?php echo $image_url[0]; ?>" <?php if(!empty($pp_display_image_title)) { ?> title="<?php echo $photo->post_title; ?>" class="<?php echo $photo->post_title; ?>" <?php } ?>>
								<img src="<?php echo $thumb_image_url[0] ?>" alt="" class="one_third_img"/>
							</a>
					<?php
    					}		
    				?>			
