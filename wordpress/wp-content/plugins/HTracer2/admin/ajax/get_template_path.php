<?php
	...
	if($Engine)
	{
		...
		echo 'HTracer '.ht_trans('определил вашу CMS как').' `$Engine`.<br /> ';
		if($Engine=='NetCat')
			echo ht_trans('Шаблоны меняются через админку').'. 
			...
			echo ht_trans('Шаблоны (темы оформления сайт) находятся в директории')." <b>`$EnginePath`</b>.";
	}
