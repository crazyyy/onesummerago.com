...
function ht_file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT)
{
    $dom = new ht_simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $defaultBRText);
...
function ht_str_get_html($str, $lowercase=true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=false, $defaultBRText=DEFAULT_BR_TEXT)
{
    $dom = new ht_simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $defaultBRText);
    if (empty($str))
    {
...
function ht_dump_html_tree($node, $show_attr=true, $deep=0)
{
    $node->dump($node);
}

class ht_simple_html_dom_node {
...
class ht_simple_html_dom {
    ...
    protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT) {
        ...
        $this->root = new ht_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new ht_simple_html_dom_node($this);
        ++$this->cursor;
