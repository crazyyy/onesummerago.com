...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'sidebar-menu' => __('Меню в виджете', 'html5blank'), // Sidebar Navigation
        'extra-menu' => __('Экстра меню', 'html5blank') // Extra Navigation if needed (duplicate as many as you need!)
    ));
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Область 1 виджета', 'html5blank'),
    ...
    register_sidebar(array(
        'name' => __('Область 2 виджета', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'widget-area-2',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
...
function create_post_type_html5()
{
    ...
    register_post_type('html5-blank', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Специальные записи', 'html5blank'), // Rename these to suit
