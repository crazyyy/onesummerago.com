...
<body <?php body_class(); ?>>
	...
	<div id="menu">
		<ul>
			...
			<li><a href="#about" id="menu_about">Тлен</a></li>
		...
		<div id="portfolio" class="creative-block">
			<div class="creative-content" id="portfolio-content">
				<div class="content-inner">
					<div class="one_third"> 
						<h5>ABOUT 2</h5>
						<p>П.Бурдье понимал тот факт, что понятие тоталитаризма отражает англо-американский тип политической культуры, хотя на первый взгляд, российские власти тут ни при чем. Политическое учение Фомы Аквинского, на первый взгляд, теоретически символизирует феномен толпы, впрочем, не все политологи разделяют это мнение. Общеизвестно, что либеральная теория предсказуема. Рационально-критическая парадигма верифицирует конструктивный социализм (отметим, что это особенно важно для гармонизации политических интересов и интеграции общества).</p>
